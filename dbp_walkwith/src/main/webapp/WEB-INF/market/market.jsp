    ...
    <div class="container" style="display: flex;">
        <div id="left-div">
            <ul id="menu">
                ...
                <li><a href="./market_menu.jsp" id="a">Market</a></li>
            </ul>
        </div>
        <div id="right-div">
            <div id="top-div">
                <div id="market-token-div">
                    ...
                    <div>
                        <div id="btn_div">
           					<a href="../review/review_write.jsp" id="a">
                            <img id="review_btn" src="../../img/Walkwith-Reviewbtn.png"></a>
                            <a href="../reservation/reservation.jsp" id="a"><img id="reservation_btn" src="../img/Walkwith-Reservationbtn.png"></a> 
                        </div>
                    </div>
                </div>
